...
class NetVLAD(nn.Module):
    ...
    def __init__(self, conf=default_conf):
        ...
        url = self.dir_models[conf['model_name']]

        download_model(url, model_dir, conf['model_name'])
        model_path = os.path.join(model_dir, conf['model_name'])
        ...
        mat = loadmat(model_path, struct_as_record=False, squeeze_me=True)
